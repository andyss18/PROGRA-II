...
public class Empleado extends Persona {
    ...
    try{
        cn=new Conexion();
        cn.abrir_conexion();
        String query = "select e.id_empleado as id,e.codigo,e.nombres,e.apellidos,e.direccion,e.telefono,e.fecha_nacimiento,p.puesto from empleados as e inner join puestos as p on e.id_puesto = p.id_puesto;";
